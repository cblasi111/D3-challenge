...
function visualize(theData) {
  ...
  //variables for our the min and max values of x and y.
  var xMin;
  var xMax;
  var yMin;
  var yMax;
  ...
  // Create scales
  // include the margin and word area
  var xScale = d3
    .scaleLinear()
    .domain([xMin, xMax])
  ...
  //grouping the dots and their labels.
  ...
  d3.selectAll(".aText").on("click", function() {
    // save a selection of the clicked text to reference it without typing out the invoker each time.
    ...
    if (self.classed("inactive")) {
      ...
      if (axis === "x") {
        ...
        d3.selectAll("circle").each(function() {
          // Each state circle gets a transition for the new attr
          d3
            .select(this)
            .transition()
            .attr("cx", function(d) {
        ...
        d3.selectAll(".stateText").each(function() {
          // each state text the same motion tween as the matching circle.
          d3
            .select(this)
            .transition()
            .attr("dx", function(d) {
    ...
    // resize function whenever the window dimensions change.
